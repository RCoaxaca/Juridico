...
/*grails.plugin.springsecurity.ipRestrictions = [
   [pattern: '/scasol/**', access: '172.19.2.125'],
   [pattern: '/scaerr/**', access: '172.19.2.122'],
   [pattern: '/opcion/**', access: '172.19.2.122']
]*/

/*grails.plugins.springsecurity.ipRestrictions = [
'/login/**': '172.19.2.100/24',                     //allow access  to admin pages only from LAN
]*/
...
'/login/**': '172.19.2.122',
'/login/**': '10.0.0.0/8',
'/login/**': ['10.10.200.42', '10.10.200.63']
]*/
