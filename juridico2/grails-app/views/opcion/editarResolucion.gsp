...
<html>
	...
	<body>
                        ...
                        <div class="panel-body">
                            <g:form method="post" >
                                ...
                                <g:checkBox name="archivo" value="${archivo}" onchange="${remoteFunction(action:'verificaResolucionArchivo',update:'todo',params:'\'expediente2=\'+ expediente2.value+\'&anio2=\'+ anio2.value')}" />Archivo Central  
                                    ...
                                    <g:if test="${oficialia==true}">
                                        <richui:richTextEditor name="nota" value="${notaInstance?.nota[1]}" width="925" height="525" />
                                    </g:if>
                                    <g:else>
        ...
        <g:if test="${notaInstanceTotal> 0}">
            <g:if test="${oficialia ==true}">
                <g:link action="toPdfOficialia" class="btn btn-primary" params="['dato1':notaInstance?.expro[0],'dato2':notaInstance?.expano[0],'dato3':sec.loggedInUserInfo(field: 'id')]" target="_new" ><g:message code="default.button.print.label" default="Generar pdf" /></g:link>
            </g:if>
            <g:else>
