     ...
     <div class="panel panel-default">
        <div class="panel-body">
						...
						<td><g:link action="edit" id="${opcionInstance.id}">${fieldValue(bean: opcionInstance, field: "tipo")}</g:link></td>
                                                 ...
                                                 <td>${fieldValue(bean: opcionInstance, field: "error")}</td>
                                                      ...
                                                      <g:if test="${opcionInstance.error.id == 1 || opcionInstance.error.id == 5 }" >  
                                                            <td><g:link controller="scaerr" action="edit2" id="${opcionInstance.tablaid}" class="btn btn-success btn-xs">aa</g:link></td>
                                                        </g:if>
                                                        <g:elseif test="${opcionInstance.error.id == 2 || opcionInstance.error.id == 3 || opcionInstance.error.id == 4 }">
                                                            <td><g:link controller="scaact" action="edit2" id="${opcionInstance.tablaid}" class="btn btn-success btn-xs">ooo</g:link></td>
                                                        </g:elseif>                               
			...
			<div class="pagination">
                ...
                <!--  <div id="nuevo">
                  <g:remoteLink class ="btn btn-primary" onmousedown="${remoteFunction(action:'mostrar',update:'nuevo')}" >Agregar nuevo</g:remoteLink>
                  </div>    
