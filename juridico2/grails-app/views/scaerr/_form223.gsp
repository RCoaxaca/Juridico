...
<div class="form-group">
    ...
    <div class="col-md-9">
	<g:select id="tcorrect" name="tcorrect.id" from="${catalogos.Tipoerror.findAllByPant(4)}" optionKey="id" required="" 
...
<div id="mun">
	...
	<label for="debeser" class="col-md-3">
        ...
        <div class="col-md-9">
            <g:textField name="debeser" value="${scaerrInstance?.debeser}" class="form-control input-sm mayuscula" onChange="conMayusculas(this)" />
        </div>
   </div>     
</div>
...
<div class="form-group">
    <label for="base" class="col-md-3">
        ...
        <div class="col-md-9">
            <g:textField name="base" value="${scaerrInstance?.base}"class="form-control input-sm mayuscula" onChange="conMayusculas(this)" />
        </div>
</div>
...
<div class="row invisible">
    ...
    <div class="col-md-2">
            <div class="form-group ${hasErrors(bean: scaerrInstance, field: 'campo', 'error')}">
                <g:select id="campo" name="campo.id" from="${catalogos.Fields.list()}" optionKey="id"  noSelection="['':'']"   value=""  />
           </div>
    </div>
