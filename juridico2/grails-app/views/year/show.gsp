	...
	<body>
		...
		<div id="show-year" class="content scaffold-show" role="main">
			...
			<ol class="property-list year">
				...
				<g:if test="${yearInstance?.xyear}">
				<li class="fieldcontain">
					<span id="xyear-label" class="property-label"><g:message code="year.xyear.label" default="Xyear" /></span>
					
						<span class="property-value" aria-labelledby="xyear-label"><g:fieldValue bean="${yearInstance}" field="xyear"/></span>
