			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="xyear" title="${message(code: 'year.xyear.label', default: 'Xyear')}" />
				...
				<g:each in="${yearInstanceList}" status="i" var="yearInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${yearInstance.id}">${fieldValue(bean: yearInstance, field: "xyear")}</g:link></td>
