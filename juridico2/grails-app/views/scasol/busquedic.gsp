                               ...
                               <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="nombre2" style='display:none;'>
                                                ...
                                                <div class="form-inline">
                                                    <g:form class="form-group" action="buscar5dic">  
                                                        <div class="row">
                                                         <div class="col-md-4">
                                                              <label class="label-control"> Interesado:</label>
                                                        </div>
                                                           <div class="col-md-8">
                                                                 <input type="text" class="form-control" name="nombreint" id="nombreint" required="">
                                                             </div>
                                                        </div>
                                                        <br>
                                                             <div class="row">
                                    ...
                                    <div id="fechaSolicitud1" style='display:none;'>
                                                ...
                                                <div class="form-inline">
                                                    <g:form class="form-group" action="buscar4dic">  
                                                        <div class="row">
